...
Escolha local. 
Não volta atrás. 
Não garante uma Solução Ótima Global.

## Aplicações Comuns

- Problema da Mochila

- Problema do Troco: Imagina que vc precia dar um troco de tal coisa com X opções, exemplo 50 reais, 20 reais, 10 reais, 5 reais e 2 reais. Como dar o troco com o mínimo de moedas possíveis?
